// Connecting to classes to js
// ----------------------------------------------------------------------------------------------------------------------------------------- //
const todo_container = document.querySelector(".todo-container");
const left_arrow = document.querySelector(".left-arrow");
const empty_completed = document.getElementsByClassName("empty-groups")[0];
var CompletedItems = JSON.parse(localStorage.getItem("Completed"));
// ----------------------------------------------------------------------------------------------------------------------------------------- //
...
function Check_ThemeBG_LS() {
    ...
    if (themebg_ls == "beach"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/beach.jpg')"
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
    if (themebg_ls == "tide"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/tide.jpg')"
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
    if (themebg_ls == "lighthouse"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/lighthouse.jpg')"
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
    if (themebg_ls == "forest"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/forest.jpg')"
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
    if (themebg_ls == "man"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/man.jpg')";
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
    if (themebg_ls == "red-bg-hill"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/red-bg-hill.jpg')"
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
    if (themebg_ls == "castle"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/castle.jpg')"
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
    if (themebg_ls == "texture-bg"){
      document.body.style.backgroundImage = "url('Frontend/Components/Completed/Modals/Change_theme/Backgrounds/texture-bg.jpg')"
      document.body.style.backgroundSize = "cover";
      document.body.style.backgroundRepeat = "no-repeat"
    }
}
...
function Get_Starred_Todo_From_Each_Local_Storage(LSName){
    ...
    var result = Current_LS.filter(element => CompletedItems.includes(element));
...
function Load_All_LS(){
    const GroupLS = JSON.parse(localStorage.getItem("Groups"));
        ...
        if (CompletedItems.length === 0){
            empty_completed.style.display = "block";
        }
